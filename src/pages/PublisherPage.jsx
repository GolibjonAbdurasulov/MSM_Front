    ...
    try {
      ...
      await axios.post(
        `${BASE_URL}/Job/CreateJob`,
        {
          ...
          jobStatus: "Created",
          mobilizedWorkers: newJob.mobilizedWorkers,
          publisherId: user.id,
          departmentId: user.departmentId,
            ...
            <div className="bg-white border border-gray-200 rounded-3xl shadow-md p-6 sticky top-6">
              ...
              <form onSubmit={handleCreateJob} className="space-y-4">
                ...
                <input
                  ...
                  min={0}
                  required
                  placeholder="Safarbar ishchilar soni"
                  value={newJob.mobilizedWorkers}
                  onChange={(e) =>
                    setNewJob({ ...newJob, mobilizedWorkers: Number(e.target.value) })
                  }
                  className="w-full border border-gray-300 rounded-2xl px-4 py-3 outline-none focus:border-emerald-500"
                />
                <input
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-4 border-t border-gray-100 pt-5">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-700">{job.mobilizedWorkers ?? 0} nafar</p>
                      </div>
                    </div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl p-8">
              ...
              <div className="space-y-4">
                ...
                <textarea
                  ...
                  className="w-full border border-gray-300 rounded-2xl px-4 py-3 outline-none focus:border-emerald-500 resize-none"
                />
                {/* ✅ mobilizedWorkers edit modal da */}
                <input
                  type="number"
                  min={0}
                  placeholder="Safarbar ishchilar soni"
                  value={selectedJob.mobilizedWorkers ?? 0}
                  onChange={(e) =>
                    setSelectedJob({
                      ...selectedJob,
                      mobilizedWorkers: Number(e.target.value),
                    })
                  }
                  className="w-full border border-gray-300 rounded-2xl px-4 py-3 outline-none focus:border-emerald-500"
                />
                <input
                  ...
                  onChange={(e) =>
                    setSelectedJob({ ...selectedJob, startedDate: e.target.value })
                  }
                  className="w-full border border-gray-300 rounded-2xl px-4 py-3 outline-none focus:border-emerald-500"
                />
                <input
                  ...
                  onChange={(e) =>
                    setSelectedJob({ ...selectedJob, endDate: e.target.value })
                  }
                  className="w-full border border-gray-300 rounded-2xl px-4 py-3 outline-none focus:border-emerald-500"
                />
              </div>
